...
# - Leave linux_vm_enable_domain_join = false to keep the Linux VM off domain and skip the domain-join secret lookups.
# - Set it to true only when you want init.sh to attempt AD join during bootstrap.
# - Leave linux_vm_domain_join_user empty to read the username from the domain-join-user Key Vault secret.
...
linux_vm_domain_join_user                 = ""
linux_vm_domain_join_username_secret_name = "domain-join-user"
