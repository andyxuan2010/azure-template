...
# -------------------------------------------------------------------
acr_resource_group_name = "rg-ba-eus-prd-shared-management"
acr_location            = "eastus"
...
# aks_resource_group_name = "rg-ba-eus-prd-shared-management"
# aks_location            = "eastus"
...
hybrid_worker_vm_resource_group = "rg-ba-eus-prd-shared-management"
...
# azure_ai_service_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# databricks_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# eventhub_resource_group_name = "rg-ba-eus-prd-shared-management"
# eventhub_location            = "eastus"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# firewall_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
# Optional override: leave commented to use app_rg and that resource group's location.
# function_app_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# function_app_storage_account_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
key_vault_resource_group_name = "rg-ba-eus-prd-shared-management"
...
linux_vm_iac_kv = "kv-ccoe-eus-prod"
linux_vm_iac_st = "stccoeiacprod"

linux_vm_app_rg      = "rg-ba-eus-prd-shared-management"
linux_vm_app_snet    = "snet-ba-cc-prod-hub-sysmgmt"
linux_vm_app_vnet_rg = "rg-ba-eus-prod-hub-network"
linux_vm_app_vnet    = "vnet-ba-eus-prod-hub"
...
linux_vm_bastion_resource_group_name = "rg-ba-eus-prod-hub-network"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# loganalytics_resource_group_name = "rg-ba-eus-prd-shared-management"
# loganalytics_location            = "eastus"
...
# -------------------------------------------------------------------
# Optional override: leave commented to use app_rg and that resource group's location.
# managed_identity_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
# Optional override: leave commented to use app_rg and that resource group's location.
# nsg_resource_group_name = "rg-ba-eus-prd-shared-management"
# nsg_location            = "eastus"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# openai_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# private_dns_resource_group_name = "rg-ba-eus-prd-shared-management"
private_dns_zones = {
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# route_table_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
# Optional overrides: leave commented to use app_rg and that resource group's location.
# servicebus_resource_group_name = "rg-ba-eus-prd-shared-management"
# servicebus_location            = "eastus"
# Optional override: leave commented to let the module generate a namespace name.
...
# Optional override: leave commented to use app_rg and that resource group's location.
# sqlmi_resource_group_name = "rg-ba-eus-prd-shared-management"
# sqlmi_location            = "eastus"
...
# -------------------------------------------------------------------
storage_account_resource_group_name = "rg-ba-eus-prd-shared-management"
...
# -------------------------------------------------------------------
vnet_resource_group_name = "rg-ba-eus-prd-shared-management"
