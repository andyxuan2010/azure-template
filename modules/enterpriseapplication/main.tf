...
# Description: Creates Microsoft Entra enterprise application and service principal configuration for application access scenarios.
#              The module manages service principal metadata, owners, feature tags, app role assignments, and related identity configuration while keeping Entra metadata separate from Azure ARM resource tagging.
...
#
# Change History:
# - 2026-06-04 v1.0.0: Established reusable enterpriseapplication module baseline for the CCOE Azure IaC template library.
