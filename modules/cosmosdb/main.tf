...
#
# Module: cosmosdb
# Description: Deploys Azure Cosmos DB accounts and related database resources for globally distributed NoSQL workloads.
#              The module supports consistency, geo-replication, backup, analytical storage, network controls, managed identity, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-22 v1.0.0: Established reusable cosmosdb module baseline for the CCOE Azure IaC template library.
