...
run "plan_identity_private_endpoint_diagnostics" {
  ...
  variables {
    ...
    private_dns_zone_ids = {
      blob = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Network/privateDnsZones/privatelink.blob.core.windows.net"
      dfs  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Network/privateDnsZones/privatelink.dfs.core.windows.net"
    }
