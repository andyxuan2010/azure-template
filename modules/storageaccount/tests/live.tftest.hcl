...
run "plan_named_storage_account" {
  ...
  assert {
    condition     = output.tags.module == "storageaccount" && output.tags.ManagedBy == "Terraform" && output.tags.Environment == "Production"
...
run "plan_generated_name_without_random" {
  ...
  assert {
    condition     = output.name == "stsharedpoceus001"
...
run "plan_hardened_data_services" {
  ...
  assert {
    condition     = output.role_assignment_count == 8
    error_message = "Role assignment count should include admin, user, custom, and current Terraform execution identity role assignments."
  }
}
...
run "plan_identity_private_endpoint_diagnostics" {
  ...
  variables {
    ...
    managed_identity_role_assignments = {
      blob_contributor = {
        scope                = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-eus-prd-shared-management"
    ...
    private_dns_zone_ids = {
      blob = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-eus-prd-shared-management/providers/Microsoft.Network/privateDnsZones/privatelink.blob.core.windows.net"
      dfs  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-eus-prd-shared-management/providers/Microsoft.Network/privateDnsZones/privatelink.dfs.core.windows.net"
    }
    ...
    diagnostic_storage_account_id  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-eus-prd-shared-management/providers/Microsoft.Storage/storageAccounts/stiactestdiag001"
  }
