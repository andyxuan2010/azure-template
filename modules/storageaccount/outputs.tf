...
output "role_assignment_count" {
  ...
  value       = length(local.app_admin_group_principal_ids) + length(local.app_user_group_principal_ids) + length(local.terraform_execution_identity_role_assignments) + length(var.role_assignments) + length(local.managed_identity_role_assignments_effective)
}
