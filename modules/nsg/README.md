...
- Priorities must be whole numbers from 100 through 4096 and unique per direction.
- Do not combine singular and plural port fields or multiple address source forms in one rule.
...
Tests use a mock Azure provider and cover rules, subnet/NIC associations, and
