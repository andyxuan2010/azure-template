...
#
# Module: servicebus
# Description: Deploys Azure Service Bus namespaces and messaging entities for enterprise integration workloads.
#              The module supports queues, topics, subscriptions, authorization rules, network controls, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable servicebus module baseline for the CCOE Azure IaC template library.
