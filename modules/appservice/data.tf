...
data "azurerm_subnet" "private_endpoint" {
  count = var.enable_private_endpoint && try(trimspace(var.private_endpoint_subnet_id), "") == "" && var.private_endpoint_subnet_name != null && var.private_endpoint_vnet_name != null && var.private_endpoint_network_resource_group_name != null ? 1 : 0
...
data "azurerm_private_dns_zone" "webapp" {
  count = var.enable_private_endpoint && try(trimspace(var.private_dns_zone_id), "") == "" && var.private_dns_zone_name != null && var.private_dns_zone_resource_group_name != null ? 1 : 0
