...
When a parent composition already knows resource-group tags, pass them through `inherited_resource_group_tags` to avoid an additional resource-group data lookup during planning.
...
module "appservice" {
  ...
  private_endpoint_vnet_name                   = "vnet-hub-prod"
