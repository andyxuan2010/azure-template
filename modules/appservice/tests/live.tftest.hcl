...
variables {
  ...
  app_service_plan_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Web/serverFarms/asp-iactest-prod-001"
  kind                = "Linux"
  auth_mode           = "none"
  app_admin_group     = []
  app_user_group      = []
...
run "plan_easy_auth_and_diagnostics" {
  ...
  variables {
    ...
    diagnostic_storage_account_id  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Storage/storageAccounts/stiactestprod001"
    diagnostic_setting_enabled_log_categories = [
      "AppServiceHTTPLogs",
...
run "plan_windows_private_endpoint" {
  ...
  variables {
    ...
    private_dns_zone_id           = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Network/privateDnsZones/privatelink.azurewebsites.net"
