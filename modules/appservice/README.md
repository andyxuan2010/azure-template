...
- Merges caller tags over optional resource-group tags without module-generated marker tags.
...
- Private endpoint subnet and DNS zone dependencies can be supplied either by resource ID or by their name/resource-group lookup fields.
- Use `application_stack` for runtime configuration instead of app settings such as `DOCKER_*`.

The Terraform test file uses mocked providers and does not deploy resources.
