...
| <a name="input_scm_ip_restriction_default_action"></a> [scm\_ip\_restriction\_default\_action](#input\_scm\_ip\_restriction\_default\_action) | The default action for Kudu/SCM endpoint traffic that does not match a restriction rule. | `string` | `"Deny"` | no |
