...
## Question Answering Search Integration

```hcl
custom_question_answering_search_service_id  = azurerm_search_service.this.id
custom_question_answering_search_service_key = azurerm_search_service.this.primary_key
```

The service ID and key must be supplied together.
