...
#
# Module: openai
# Description: Deploys Azure OpenAI or AI Foundry account resources for generative AI workload enablement.
#              The module supports account configuration, deployments, model settings, network controls, managed identity, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable openai module baseline for the CCOE Azure IaC template library.
