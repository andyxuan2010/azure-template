...
Provision an Azure Resource Group with standardized naming, caller-controlled tags, optional management locks, and flexible role assignments at the resource group scope.
...
- Applies only caller-provided tags without module-generated governance or marker tags.
...
- Locks are created after module-owned RBAC assignments to avoid ReadOnly lock ordering failures.
