...
Subnet names are the `subnets` map keys. Azure subnets do not support ARM tags. Follow the repository [naming convention](../../docs/60-security-governance/naming-convention.md); apply the [tagging standard](../../docs/60-security-governance/tagging-standard.md) to the parent VNet and associated resources.
