...
# Description: Deploys Azure Application Gateway resources for Layer 7 ingress, routing, and optional WAF enforcement.
#              The module supports public IP creation, frontend listeners, backend pools, HTTP settings, probes, routing rules, SSL certificates, autoscale, diagnostics, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-07 v1.0.0: Established reusable applicationgateway module baseline for the CCOE Azure IaC template library.
