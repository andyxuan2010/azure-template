...
# Description: Deploys Azure AI Services accounts for cognitive, language, speech, vision, OpenAI-compatible, and related AI capabilities.
#              The module supports account kind and SKU selection, custom subdomains, network controls, managed identity, deployments, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable azure_ai_service module baseline for the CCOE Azure IaC template library.
