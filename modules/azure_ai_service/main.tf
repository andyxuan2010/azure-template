...
resource "azurerm_cognitive_account" "this" {
  ...
  lifecycle {
    precondition {
      condition     = var.customer_managed_key == null || var.identity != null
      error_message = "customer_managed_key requires identity to be configured on the Azure AI Services account."
    }
  }
}
