...
Requires Terraform `>= 1.5`. Module tags are the inherited resource-group tags (when enabled) merged with caller-supplied `tags`; no implicit environment or module-marker tags are generated.
