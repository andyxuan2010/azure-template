...
#
# Module: sqldb
# Description: Deploys Azure SQL Database resources and related SQL platform configuration.
#              The module supports SQL server or database composition, database settings, elastic pool or standalone patterns, backup and license options, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable sqldb module baseline for the CCOE Azure IaC template library.
...
resource "azurerm_mssql_database" "sql_db" {
  ...
  max_size_gb                                                = local.database_max_size_gb
