...
```hcl
validation {
  condition     = can(regex("^[a-zA-Z0-9._()-]{1,90}$", var.sql_rg_name))
...
sql_max_size_gb          = 50
sql_sku_name             = "S0"
sql_admin_password       = "DevPass@123"
...
```hcl
app_env                    = "prod"
sql_server_name           = "sql-prod-001"
sql_database_name         = "appdb"
sql_max_size_gb           = 500
sql_sku_name              = "P4"
sql_admin_password        = "ProdSecure@Pass123"
sql_ad_admin_id           = "12345678-1234-1234-1234-123456789012"
...
```hcl
sql_server_name = "SQL-PROD-001"  # Uppercase not allowed
```
**Expected**: ❌ FAIL
...
```hcl
sql_admin_password = "Pass123"  # Only 7 chars
```
**Expected**: ❌ FAIL
...
```hcl
sql_ad_admin_id = "admin@company.com"  # Email, not UUID
```
**Expected**: ❌ FAIL
...
```hcl
sql_max_size_gb = 5000  # Exceeds max
```
**Expected**: ❌ FAIL
