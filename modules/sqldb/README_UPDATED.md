...
module "sql_db" {
  ...
  # Required
  server_name   = "sql-prod-001"        # Globally unique
  database_name = "appdb"
  max_size_gb   = 500
  sku_name      = "P4"

  admin_username = "sqladmin"
  admin_password = var.sql_password     # Use tfvars
  ad_admin_login_name       = "admin@company.com"
  ad_admin_object_id    = "12345678..."        # UUID format
