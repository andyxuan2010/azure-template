...
|----------|------|---------------|
| server_name | 1-63 chars, lowercase, alphanumeric, hyphens | Name format validation |
| database_name | 1-128 chars, alphanumeric, underscore, hyphen | Name format validation |
| max_size_gb | 1-4096 GB | Size bounds validation |
| sku_name | Valid SKU format | SKU format validation |
| admin_username | 1-128 chars, starts with letter | Username format validation |
| admin_password | Min 8 characters | Password strength validation |
| ad_admin_object_id | Valid UUID format | AD object ID validation |
...
| minimum_tls_version | 1.0, 1.1, 1.2 | TLS version validation |
| collation | Valid SQL Server collation | Collation format validation |
...
module "sql_db" {
  ...
  ad_admin_login_name     = "admin@company.onmicrosoft.com"
...
|--------|---------|---------|
| server_name | Server name | sql-prod-001 |
