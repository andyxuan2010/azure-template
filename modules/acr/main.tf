...
#
# Module: acr
# Description: Deploys and configures Azure Container Registry resources for application and platform container image hosting.
#              The module supports standardized naming, SKU and network controls, managed identity integration, optional private endpoint composition, role assignments, georeplication settings, diagnostics, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable acr module baseline for the CCOE Azure IaC template library.
