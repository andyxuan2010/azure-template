...
See the repository [module dependency guide](../../docs/20-repository/module-usage-and-dependencies.md) for composition order.
...
The module merges inherited resource-group tags with caller tags. Follow the repository [naming convention](../../docs/60-security-governance/naming-convention.md) and [tagging standard](../../docs/60-security-governance/tagging-standard.md).
