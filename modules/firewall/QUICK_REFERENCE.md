...
- Public IP version: Azure Firewall public IP configurations use IPv4.
...
- Policy attachment: set either `create_firewall_policy = true` or `firewall_policy_id`, not both.
