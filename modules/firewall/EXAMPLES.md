...
- Tests use mock Azure providers and do not require a live resource group.
- Use IPv4 Standard public IPs for Azure Firewall.
- Do not set both `create_firewall_policy = true` and `firewall_policy_id`.
- A module-created Firewall Policy SKU must match `sku_tier`.
