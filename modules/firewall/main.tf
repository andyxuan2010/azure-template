...
#
# Module: firewall
# Description: Deploys Azure Firewall and related network security resources for centralized egress and ingress control.
#              The module supports firewall policy association, public IPs, IP configurations, rule collections, diagnostics, forced tunneling patterns, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable firewall module baseline for the CCOE Azure IaC template library.
