...
#
# Module: keyvault
# Description: Deploys Azure Key Vault resources for secrets, keys, certificates, and secure platform configuration.
#              The module supports RBAC or access policy patterns, purge protection controls, network access controls, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable keyvault module baseline for the CCOE Azure IaC template library.
...
resource "azurerm_role_assignment" "current_terraform_service_principal" {
  for_each = local.current_terraform_service_principal_role_assignments
