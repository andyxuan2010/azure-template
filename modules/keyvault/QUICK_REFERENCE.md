...
Default behavior: public network access is disabled and network ACLs are enabled with a `Deny` default action. Supply explicit IP rules, subnet IDs, or a private endpoint before expecting connectivity.
