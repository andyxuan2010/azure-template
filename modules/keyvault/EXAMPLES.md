...
- Caller role elevation is disabled by default; enable it only when Terraform requires those roles.
...
- When using DNS lookup by name, set `private_dns_zone_resource_group_name`.
