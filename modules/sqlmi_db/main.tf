...
#
# Module: sqlmi_db
# Description: Manages Azure SQL Managed Instance databases and related access assignments.
#              The module supports standardized naming, resource-specific tags, Microsoft Entra group role assignments, parent managed instance lookup, and resource group tag inheritance for consistent governance across managed database resources.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable sqlmi_db module baseline for the CCOE Azure IaC template library.
# - 2026-07-08 v1.0.0: Standardized tag inheritance to prefer SQL Managed Instance resource group tags before database-specific tags.
