...
variable "create_subnets" {
  description = "Whether the module creates interface subnets in an existing VNet. When false, every interface must supply subnet_id."
  type        = bool
  default     = false
}

variable "virtual_network_name" {
  description = "Existing VNet name used when create_subnets is true."
  type        = string
  default     = ""
}

variable "virtual_network_resource_group_name" {
  description = "Resource group containing the existing VNet. Defaults to resource_group_name."
  type        = string
  default     = ""
}
