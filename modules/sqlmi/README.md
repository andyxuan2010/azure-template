...
Set `name` explicitly or allow `sqlmi-<workload>-<location-code>-<environment>-<instance>` generation. See the repository [naming convention](../../docs/60-security-governance/naming-convention.md) and [tagging standard](../../docs/60-security-governance/tagging-standard.md).
