...
#
# Module: sqlmi
# Description: Deploys Azure SQL Managed Instance resources for managed SQL Server compatibility with platform-managed operations.
#              The module supports managed instance naming, networking, identity, storage and license configuration, administrator integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable sqlmi module baseline for the CCOE Azure IaC template library.
