...
Two map entries that resolve to the same deterministic assignment name are rejected during planning. This prevents duplicate logical assignments within one module call.
