...
variable "integration_subnet_id" {
  description = "Resource ID of the delegated regional VNet integration subnet."
  type        = string
}

variable "private_endpoint_subnet_id" {
  description = "Resource ID of the separate private endpoint subnet."
  type        = string
}
