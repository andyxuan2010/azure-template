...
Provision Azure Logic App Standard with storage integration, networking, RBAC, and diagnostics.
...
```hcl
module "logicapp" {
  source = "git::https://dev.azure.com/CCOE-Azure/CCoE-Infra-IaC/_git/template//modules/logicapp?ref=main"
