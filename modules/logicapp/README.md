...
A typical composition is `storageaccount + appserviceplan + networking -> logicapp`. See the repository [module dependency guide](../../docs/20-repository/module-usage-and-dependencies.md).
