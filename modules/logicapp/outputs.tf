...
output "private_endpoint_enabled" {
  description = "Whether the Logic App private endpoint is enabled."
...
output "diagnostics_enabled" {
  description = "Whether Logic App diagnostic settings are enabled."
  value       = var.enable_diagnostics
}

output "identity_type" {
  description = "Managed identity type configured on the Logic App."
