...
# Description: Creates Microsoft Entra application registrations and related service principal configuration for identity integration scenarios.
#              The module manages application metadata, owners, redirect URIs, API permissions, federated identity credentials, feature tags, and optional credentials while keeping Entra tags separate from Azure ARM resource tags.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable appregistration module baseline for the CCOE Azure IaC template library.
