...
Microsoft Entra application tags are strings rather than Azure Resource Manager key/value tags. Follow the repository [naming convention](../../docs/60-security-governance/naming-convention.md); the ARM [tagging standard](../../docs/60-security-governance/tagging-standard.md) does not apply directly to directory objects.
