...
- Federated identity credentials can be created without also creating a service principal.
...
The test file uses mocked providers and does not create Entra or Azure resources.
