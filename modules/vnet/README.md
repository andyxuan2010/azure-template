...
- Creates managed resources including `azurerm_monitor_diagnostic_setting`, `azurerm_role_assignment`, `azurerm_subnet`, and `azurerm_virtual_network`.
...
- Supports plan-known inherited resource-group tags to avoid an unnecessary data lookup.
- Uses deterministic mocked plan tests.
