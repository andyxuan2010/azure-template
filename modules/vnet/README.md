...
Set an explicit VNet name for stable naming. Otherwise the generated name combines workload/application metadata, location, and a random suffix. Caller tags override inherited resource-group tags. Subnets cannot be tagged. See the repository [naming convention](../../docs/60-security-governance/naming-convention.md) and [tagging standard](../../docs/60-security-governance/tagging-standard.md).
