...
output "role_assignment_ids" {
  ...
  value = {
    ...
    resource_group_reader                 = [for role in azurerm_role_assignment.resource_group_reader : role.id]
    bastion_resource_group_reader         = [for role in azurerm_role_assignment.bastion_resource_group_reader : role.id]
    bastion_network_contributor           = [for role in azurerm_role_assignment.bastion_network_contributor : role.id]
