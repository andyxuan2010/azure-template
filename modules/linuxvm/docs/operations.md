...
It is an operations-oriented companion to the module [README](../README.md), [authentication guide](authentication.md), [bootstrap notes](../scripts/INIT.md), and [localization notes](../scripts/LOCALIZATION.md).
...
- bootstrap via `custom_data` using the module-owned [`scripts/init.sh`](../scripts/init.sh)
...
1. `custom_data` bootstrap via [`scripts/init.sh`](../scripts/init.sh)
...
The base `init.sh` script installs and configures a broad Linux administration and platform baseline. See the [bootstrap notes](../scripts/INIT.md) for detail.
...
For detailed behavior, see the [localization notes](../scripts/LOCALIZATION.md).
