...
variable "admin_username_secret_name" {
  type        = string
  default     = ""
  description = "Optional Key Vault secret name containing the Linux VM admin username. Used only when disable_password_authentication is false and admin_username is empty."
}

variable "admin_password_secret_name" {
  type        = string
  default     = ""
  description = "Optional Key Vault secret name containing the Linux VM admin password. Used only when disable_password_authentication is false and admin_password is empty."
}

variable "admin_ssh_key_secret_name" {
  type        = string
  default     = ""
  description = "Optional Key Vault secret name containing the Linux VM admin SSH public key. Used when admin_ssh_key is empty. The effective SSH key remains mandatory."
}
