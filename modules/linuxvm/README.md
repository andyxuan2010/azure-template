...
- `admin_username`: Admin username for the Linux VM local administrator account. `string` (required)
- `admin_password`: Admin password for the Linux VM local administrator account. `string` (required, sensitive)
- `admin_ssh_key`: SSH public key for the Linux VM local administrator account. `string` (required, sensitive)
