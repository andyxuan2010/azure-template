locals {
  ...
  admin_password_input_effective = trimspace(nonsensitive(coalesce(var.admin_password, "")))
  admin_ssh_key_input_effective  = trimspace(nonsensitive(coalesce(var.admin_ssh_key, "")))
  ...
  admin_password_effective = var.disable_password_authentication ? null : coalesce(
  ...
  admin_ssh_key_effective = coalesce(
