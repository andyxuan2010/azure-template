locals {
  ...
  admin_username_input_effective = trimspace(var.admin_username)
  admin_password_input_effective = trimspace(var.admin_password)
  admin_ssh_key_input_effective  = trimspace(var.admin_ssh_key)
  admin_username_input_provided  = local.admin_username_input_effective != ""
  admin_password_input_provided  = trimspace(nonsensitive(var.admin_password)) != ""
  admin_ssh_key_input_provided   = trimspace(nonsensitive(var.admin_ssh_key)) != ""
  ...
  admin_username_effective = var.disable_password_authentication ? "azureadmin" : coalesce(
