locals {
  ...
  admin_password_input_provided  = local.admin_password_input_effective != ""
  admin_ssh_key_input_provided   = local.admin_ssh_key_input_effective != ""

  admin_credentials_key_vault_enabled  = local.admin_credentials_key_vault_id_effective != ""
  admin_username_secret_lookup_enabled = !var.disable_password_authentication && local.admin_credentials_key_vault_enabled && !local.admin_username_input_provided && local.admin_username_secret_name_effective != ""
  admin_password_secret_lookup_enabled = !var.disable_password_authentication && local.admin_credentials_key_vault_enabled && !local.admin_password_input_provided && local.admin_password_secret_name_effective != ""
  admin_ssh_key_secret_lookup_enabled  = local.admin_credentials_key_vault_enabled && !local.admin_ssh_key_input_provided && local.admin_ssh_key_secret_name_effective != ""
