...
See the repository [module dependency guide](../../docs/20-repository/module-usage-and-dependencies.md) and the [AKS `kubelogin` guide](../../docs/30-deployment/aks-authentication-kubelogin.md).
...
The module merges inherited resource-group tags with caller tags without adding module marker tags. Follow the repository [naming convention](../../docs/60-security-governance/naming-convention.md) and [tagging standard](../../docs/60-security-governance/tagging-standard.md).
