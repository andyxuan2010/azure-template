...
#
# Module: aks
# Description: Deploys Azure Kubernetes Service clusters for containerized workload hosting on Azure.
#              The module supports standardized naming, managed identity, node pools, networking, Azure RBAC, workload identity, diagnostics, maintenance and upgrade controls, private cluster patterns, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable aks module baseline for the CCOE Azure IaC template library.
