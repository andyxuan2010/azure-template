...
Read the module [architecture guide](docs/architecture.md) and repository [dependency guide](../../docs/20-repository/module-usage-and-dependencies.md) before enabling production private access or runbook automation.
