...
# Description: Deploys Azure Automation Account resources for runbook automation and operational task execution.
#              The module supports managed identity, runbooks, schedules, job schedules, variables, credentials, modules, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-04-17 v1.0.0: Established reusable automationaccount module baseline for the CCOE Azure IaC template library.
