...
- `tests/live.tftest.hcl` uses mock Azure providers and validates named resources, deterministic generated names, RBAC and diagnostics, private endpoints, runbooks, schedules, job schedules, variables, and invalid JSON rejection.

## Notes

- Each runbook may use inline `content` or `publish_content_link`, but not both.
- Schedule intervals must be positive whole numbers.
- Datetime variables require RFC3339 timestamps and object variables require valid JSON.
