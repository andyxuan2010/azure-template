...
run "plan_private_endpoint_runbooks_schedules_and_variables" {
  ...
  variables {
    ...
    private_dns_zone_id             = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Network/privateDnsZones/privatelink.azure-automation.net"
    ...
    job_schedules = {
      hello_daily = {
        ...
        schedule_name = "daily"
        parameters = {
          resourcegroup = "rg-ba-cc-prd-shared-management"
        }
      }
    }
