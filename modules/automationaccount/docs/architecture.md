# Azure Automation Account Architecture

## Scope

This document describes the resource topology, security boundaries, network model, observability, and operational tradeoffs of `modules/automationaccount`.
...
`tests/unit.tftest.hcl` uses mock Azure providers and covers named resources, deterministic generated naming, caller-controlled tags, identity, RBAC, diagnostics, private endpoints, runbooks, schedules, job schedules, variables, and malformed input rejection.
