...
`tests/live.tftest.hcl` uses mock Azure providers and covers named resources, deterministic generated naming, caller-controlled tags, identity, RBAC, diagnostics, private endpoints, runbooks, schedules, job schedules, variables, and malformed input rejection.
