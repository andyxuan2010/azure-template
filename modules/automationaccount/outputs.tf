...
output "private_dns_zone_id" {
  description = "Resolved private DNS zone ID linked to private endpoints, if configured."
  value       = local.private_dns_zone_id_resolved != "" ? local.private_dns_zone_id_resolved : null
}
