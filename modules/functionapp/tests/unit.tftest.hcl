...
variables {
  ...
  app_env                    = "dev"
  os_type                    = "Linux"
  service_plan_id            = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Web/serverFarms/asp-iactest-dev-001"
...
run "plan_linux_secure_defaults" {
  ...
  assert {
    ...
    error_message = "Function App should preserve caller tags without adding module-generated tags."
  }
}

run "reject_conflicting_storage_auth_modes" {
  command = plan

  variables {
    storage_uses_managed_identity    = true
    storage_key_vault_secret_id      = "https://kv-example.vault.azure.net/secrets/storage/00000000000000000000000000000000"
...
run "reject_ambiguous_ip_restriction" {
  command = plan
...
run "plan_generated_name_without_random" {
  ...
  variables {
    ...
    os_type                     = "Linux"
    service_plan_id             = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Web/serverFarms/asp-orders-poc-001"
  ...
  assert {
    condition     = output.name == "func-orders-poc-cc-001"
...
run "plan_managed_identity_storage_network_and_auth" {
  ...
  variables {
    ...
    app_env                       = "prod"
    os_type                       = "Linux"
    service_plan_id               = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Web/serverFarms/asp-iactest-prod-001"
...
run "plan_windows_private_endpoint_diagnostics_and_key_vault_storage" {
  ...
  variables {
    ...
    app_env                          = "prod"
    os_type                          = "Windows"
    service_plan_id                  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ccoe-iac-cc-dev/providers/Microsoft.Web/serverFarms/asp-iactest-sec-001"
