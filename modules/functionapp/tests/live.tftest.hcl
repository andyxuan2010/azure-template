...
variables {
  ...
  app_env                    = "dev"
  os_type                    = "Linux"
  service_plan_id            = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Web/serverFarms/asp-iactest-dev-001"
...
run "plan_generated_name_without_random" {
  ...
  variables {
    ...
    os_type                     = "Linux"
    service_plan_id             = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Web/serverFarms/asp-orders-poc-001"
...
run "plan_managed_identity_storage_network_and_auth" {
  ...
  variables {
    ...
    app_env                       = "prod"
    os_type                       = "Linux"
    service_plan_id               = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Web/serverFarms/asp-iactest-prod-001"
...
run "plan_windows_private_endpoint_diagnostics_and_key_vault_storage" {
  ...
  variables {
    ...
    app_env                          = "prod"
    os_type                          = "Windows"
    service_plan_id                  = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-ba-cc-prd-shared-management/providers/Microsoft.Web/serverFarms/asp-iactest-sec-001"
