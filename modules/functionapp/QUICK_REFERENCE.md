...
- Each restriction sets exactly one source: CIDR, service tag, or subnet ID.
...
Storage authentication modes are mutually exclusive. Managed-identity and Key
Vault secret modes require a configured managed identity.
