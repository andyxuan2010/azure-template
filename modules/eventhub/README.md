...
- Validates SKU support for CMK, Schema Registry, and Geo-DR, plus capture identity requirements.
...
- Mock-provider plan tests that do not deploy Azure resources.
