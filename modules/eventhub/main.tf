...
#
# Module: eventhub
# Description: Deploys Azure Event Hubs namespaces and messaging resources for streaming data ingestion and event-driven workloads.
#              The module supports namespaces, event hubs, consumer groups, authorization rules, capture, network controls, private endpoint integration, diagnostics, role assignments, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-20 v1.0.0: Established reusable eventhub module baseline for the CCOE Azure IaC template library.
