...
- CMK requires Premium SKU. Schema Registry and Geo-DR require Standard or Premium.
- Identity-authenticated Capture must reference a managed identity attached to the namespace.
