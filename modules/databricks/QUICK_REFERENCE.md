...
- `app_admin_group`, `app_user_group`, `role_assignments`, `access_connector_role_assignments`: RBAC controls.
...
- `role_assignment_ids`, `access_connector_role_assignment_ids`, `role_assignment_count`
- `tags`
