...
resource "azurerm_role_assignment" "app_admin_group_storage_account_contributor" {
  for_each = local.custom_storage_account_name != "" ? local.app_admin_group_principal_ids : {}
...
resource "azurerm_role_assignment" "app_user_group_storage_account_reader" {
  for_each = local.custom_storage_account_name != "" ? local.app_user_group_principal_ids : {}
