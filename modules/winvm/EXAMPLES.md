...
- Entra object IDs are preferred for Azure RBAC, but Windows local group membership requires a resolvable account name or SID. GUID object IDs are skipped locally by `init2.ps1` with a warning.
