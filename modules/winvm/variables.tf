...
variable "primary_dns_suffix" {
  description = "Optional Windows primary DNS suffix override applied after Active Directory domain join. Leave empty to retain the domain-join default. A reboot is scheduled when the suffix changes."
  type        = string
  default     = ""
