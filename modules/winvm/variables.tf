...
variable "azure-user" {
  type        = string
  default     = ""
  description = "Admin username for the Windows VM local administrator account. Leave empty to use the azure-user secret from Key Vault."
}

variable "azure-password" {
  type        = string
  default     = ""
  description = "Admin password for the Windows VM local administrator account. Leave empty to use the azure-password secret from Key Vault."
  sensitive   = true
}
