locals {
  ...
  admin_credentials_key_vault_id_effective = trimspace(var.admin_credentials_key_vault_id) != "" ? trimspace(var.admin_credentials_key_vault_id) : data.azurerm_key_vault.iac.id
