locals {
  ...
  windows_group_domain_prefix_effective = trimsuffix(trimspace(var.windows_group_domain_prefix), "\\")
  ...
  tags = merge(
    var.inherit_resource_group_tags ? try(data.azurerm_resource_group.app.tags, {}) : {},
    var.tags,
    {
