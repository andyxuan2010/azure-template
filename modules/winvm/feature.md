...
- Downloads module-owned assets such as `scheduled.ps1`, `default.bgi`, and `background.png` from the scripts container.
...
- Configures BGInfo and the background wallpaper.
