...
- Subscription placement is managed declaratively; changes to `subscription_ids` are no longer ignored.
...
Tests use mock providers and validate hierarchy inputs, metadata output, and
