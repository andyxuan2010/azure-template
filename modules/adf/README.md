...
See the repository [module dependency guide](../../docs/20-repository/module-usage-and-dependencies.md) before enabling private networking or SHIR.
...
Inherited resource-group tags form the baseline and caller `tags` can add resource metadata. Follow the repository [naming convention](../../docs/60-security-governance/naming-convention.md) and [tagging standard](../../docs/60-security-governance/tagging-standard.md).
