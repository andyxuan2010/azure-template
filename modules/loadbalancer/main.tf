...
#
# Module: loadbalancer
# Description: Deploys Azure Load Balancer resources for Layer 4 traffic distribution across workload backends.
#              The module supports frontend IP configurations, backend pools, probes, load balancing and NAT rules, public or private patterns, diagnostics, and resource group tag inheritance for governance alignment.
...
#
# Change History:
# - 2026-05-13 v1.0.0: Established reusable loadbalancer module baseline for the CCOE Azure IaC template library.
