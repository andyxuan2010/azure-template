...
usage() {
  cat <<'EOF'
Usage:
  scripts/module-harness-targets.sh detect --base <ref> --head <ref> --format <github-matrix|ado-matrix|json-array|newline>
  scripts/module-harness-targets.sh overrides --module <name> --output <path>
EOF
}
