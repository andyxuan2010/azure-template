...
network_resource_group_name     = "rg-ccoe-iac-cc-dev"
private_dns_resource_group_name = "rg-platform-dev"
shared_vnet_name                = "vnet-ba-cc-prd-shared-management-01"
app_subnet_name                 = "app"
...
containerapp_name           = ""
containerapp_environment_id = ""
containerapp_revision_mode  = "Single"
containerapp_containers = [{
  name   = "app"
  image  = "mcr.microsoft.com/azuredocs/containerapps-helloworld:latest"
  cpu    = 0.25
  memory = "0.5Gi"
}]
containerapp_ingress = {
  external_enabled = true
  target_port      = 8080
}
containerapp_min_replicas = 0
containerapp_max_replicas = 1
containerapp_secrets      = []
containerapp_registries   = []
...
private_endpoint_private_connection_resource_id       = ""
private_endpoint_subresource_names                    = ["blob"]
private_endpoint_private_dns_zone_ids                 = []
private_endpoint_private_dns_zone_names               = []
private_endpoint_private_dns_zone_resource_group_name = ""
...
sqlmi_administrator_login_password = ""
