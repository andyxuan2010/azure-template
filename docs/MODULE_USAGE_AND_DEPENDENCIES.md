...
| `availabilityset` | Azure Availability Set for VM fault-domain and update-domain placement | Existing resource group | Proximity placement group, VM modules or VM resources that consume the Availability Set ID | `modules/availabilityset/EXAMPLES.md` |
