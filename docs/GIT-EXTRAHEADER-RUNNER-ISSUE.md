...
fatal: could not read Password for 'https://CCOE-Azure@dev.azure.com': terminal prompts disabled
...
```text
http.https://dev.azure.com/CCOE-Azure.extraheader
```
...
http.https://CCOE-Azure@dev.azure.com.extraheader
```
...
This fix is implemented in [azure-pipelines.yml](../../web-ccoedemo-dev-node-601/azure-pipelines.yml).
...
- Pipeline file: [azure-pipelines.yml](../../web-ccoedemo-dev-node-601/azure-pipelines.yml)
- Documentation folder: [docs](../../web-ccoedemo-dev-node-601/docs)
