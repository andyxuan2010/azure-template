...
For the complete GitHub Actions job flow and configuration reference, see [GitHub Actions Terraform Pipeline](../40-pipelines/github-actions-pipeline.md).
...
1. Trivy HIGH/CRITICAL Terraform misconfiguration and secret scanning
2. `terraform fmt -check -recursive`
3. backend-free `terraform init`
