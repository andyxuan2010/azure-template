...
* Use the power of open-source. Always take a look, at least for inspiration, on [Terraform's Registry](https://registry.terraform.io/) and [GitHub](../../references/github.com). There is always opportunity to learn there.
