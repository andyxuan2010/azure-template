...
Current normalized reference modules are `acr`, `adf`, `aks`, `applicationgateway`, `appregistration`, `appservice`, `appserviceplan`, `automationaccount`, `availabilityset`, `azure_ai_service`, `azure_ai_search`, `containerapp`, `cosmosdb`, `databricks`, `enterpriseapplication`, `eventhub`, `firewall`, `fortigate`, `functionapp`, `keyvault`, `linuxvm`, `loadbalancer`, `loganalytics`, `logicapp`, `managedidentity`, `managementgroups`, `nsg`, `openai`, `policy`, `private_dns`, `private_endpoint`, `rg`, and `roleassignments`.
