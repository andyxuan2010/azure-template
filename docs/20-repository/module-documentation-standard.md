...
| Reference implementations | All 46 modules under `modules/` |
...
Link to the repository [naming convention](../60-security-governance/naming-convention.md) and [tagging standard](../60-security-governance/tagging-standard.md).
...
| Cross-module dependencies | Root `docs/20-repository/module-usage-and-dependencies.md` |
| Module navigation | Root `docs/20-repository/modules-index.md` |
...
- [`modules/eventgridsystemtopic`](../../modules/eventgridsystemtopic/)
- [`modules/eventhub`](../../modules/eventhub/)
- [`modules/firewall`](../../modules/firewall/)
- [`modules/fortigate`](../../modules/fortigate/)
- [`modules/functionappflex`](../../modules/functionappflex/)
- [`modules/route_table`](../../modules/route_table/)
- [`modules/servicebus`](../../modules/servicebus/)
- [`modules/staticwebapp`](../../modules/staticwebapp/)
- [`modules/sqldb`](../../modules/sqldb/)
- [`modules/sqlmi`](../../modules/sqlmi/)
- [`modules/sqlmi_db`](../../modules/sqlmi_db/)
